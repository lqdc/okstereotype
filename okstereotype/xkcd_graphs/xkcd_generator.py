#!/usr/bin/env python
'''
@file xkcd_generator.py
@date Wed 23 Jan 2013 02:12:19 PM EST
...
import matplotlib.lines as pl
import matplotlib

# We need a special font for the code below.  It can be downloaded this way:
import os
import urllib2
fname = "/home/roman/Dropbox/django_practice/mysite/Humor-Sans.ttf"
if not os.path.exists(fname):
    fhandle = urllib2.urlopen('http://antiyawn.com/uploads/Humor-Sans.ttf')
    open(fname, 'wb').write(fhandle.read())
...
def XKCDify(ax, mag=1.0,
    ...
    prop = fm.FontProperties(fname=fname, size=16)
